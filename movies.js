...
$(function () {
  ...
  $("#new-movie-form").on("submit", function (evt) {
    ...
    // create movieData object with current id
    let movieData = { title, rating, currentId };
    //create const containing HTML tables based on movieData
    const HTMLtoAppend = createMovieDataHTML(movieData);

    currentId++;

    //add to list for future sorting
    moviesList.push(movieData);
    // add HTML to append to movie table body in html
